    ...
    <div class="trang_chu">
        <div class="tieu_de">
            ...
            <ul class="nav">
                <li>
                    <h1>
                        <a class="logo" href="index.php">The Coffee House</a>
                    </h1>
                </li>
                <li><a href="quanLySP.php">Sản phẩm</a></li>
                <li>
                    <a href="quanLyKH.php">Người dùng</a>
                </li>
                <li>
                    <a href="quanLyDH.php">Đơn hàng</a>
                </li>
