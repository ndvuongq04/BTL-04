...
function insertOrder($con, $idNguoiDung, $tongTien, $diaChi, $soDienThoai, $tenNguoiNhan, $trangThai)
{
    // Câu lệnh SQL
    $sql = "INSERT INTO don_hang (id_nguoi_dung, tong_tien, dia_chi, sdt, ten,trang_thai) VALUES (?, ?, ?, ?,?,?);";
    ...
    if ($stmt) {
        ...
        // Gán tham số
        $stmt->bind_param("iissss", $idNguoiDung, $tongTien, $diaChi, $soDienThoai, $tenNguoiNhan, $trangThai);
